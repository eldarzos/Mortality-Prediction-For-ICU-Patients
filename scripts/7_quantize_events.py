...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Quantize events using value dictionary and create token mapping.')
    parser.add_argument('root_dir',
                        type=str,
                        help='Root directory containing subject folders, "splits", and "dictionaries".')
    parser.add_argument('-t', '--t-hours',
                        type=int, required=True,
                        help='Time window (e.g., 24 or 48) for quantization.')
    parser.add_argument('-n', '--n-bins',
                        type=int, default=10,
                        help='Number of percentile bins for continuous variables (default: 10).')
    ...
    quantize_events(args.root_dir, args.t_hours, args.n_bins, args.seed)
