...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Extract episodes (static data and timeseries) from per-subject data.')
    parser.add_argument(
        'root_path', type=str,
        help='Directory containing subject sub-directories (output of 2_validate_events.py).')
    args = parser.parse_args()

    subject2episode(args.root_path)
